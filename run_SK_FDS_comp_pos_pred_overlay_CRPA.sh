...
FHC_NOM_NAME="${NOM_DIR}/1Doutputs_ToyXP_SKT2K_AsimovA_CRPA_20230703.root"
COMP_LABEL="SK-T2K"
...
OUTNAME="CRPA_comp_Asimov1_T2KNOvA_posPred_FDS_fit_addSKT2K"
...
eval "root -l -b -q 'SK_FDS_comp_pos_pred_overlay.C(\"${FHC_FDS_NAME}\", \"${FDS_LABEL}\", \"${FHC_NOM_NAME}\", \"${POS_PRED_FILE}\", \"${COMP_LABEL}\", \"${OUTNAME}\", \"${POSPRED_LABEL}\", false)'"
